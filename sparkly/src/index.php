  ...
  <div class="container">
    ...
    <a href="riwayat.php" class="btn btn-light mb-3 mx" style="float: right;">Riwayat</a>
      ...
      <div class="text-center mb-4">
        <h3>Dashboard</h3>
        <p class="text-muted">Tekan tombol Cuci untuk input data cucian, tombol Ambil untuk proses transaksi dan menyelesaikan cucian.</p>
      </div>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="edit.php?id=<?php echo $row["no_nota"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
              <a href="delete.php?id=<?php echo $row["no_nota"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
